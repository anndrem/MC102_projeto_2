...
class CheckCards():
    '''
    Analisa e compara cartas usando uma ordem numérica de força.
    Permite identificar manilhas, ordenar cartas e verificar vencedores.
    '''
    def __init__(self, hand_cards, top_card = None):
        '''
        Inicializa a mão e a carta virada, definindo as ordens de comparação.
        '''
    ...
    def _listIdx(self):
        '''
        Converte cartas e naipes em índices para facilitar comparações.
        '''
